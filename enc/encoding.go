...
type EncoderResolver func(i interface{}) ([]byte, error)

var Resolver EncoderResolver
...
func Encode(v interface{}, asArray bool) ([]byte, error) {
	if Resolver == nil {
		return nil, fmt.Errorf("error")
	}

	if b, err := Resolver(v); err != nil {
		return nil, err
	} else if b != nil {
		return b, nil
	}
